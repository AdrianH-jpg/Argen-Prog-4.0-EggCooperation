...
public class Esqueleto {
    ...
    public Esqueleto(int nivelSalud, String nombreArmadura, String colorPrimario, String colorSecundario, int resistencia, Botas botaIzquierda, Botas botaDerecha, Guantes guanteIzquierdo, Guantes guanteDerecho, Casco casco, Generador bateria) {
