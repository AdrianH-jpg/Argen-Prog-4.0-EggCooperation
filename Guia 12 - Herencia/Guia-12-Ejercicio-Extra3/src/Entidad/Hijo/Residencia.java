...
public class Residencia extends AlojamientoExtraHotelero {
    ...
    public Residencia(int cantHabitaciones, boolean desGremios, boolean campDeportivo, boolean privado, int metrosCuadrados, String nombre, String direccion, String localidad, String gerente) {
