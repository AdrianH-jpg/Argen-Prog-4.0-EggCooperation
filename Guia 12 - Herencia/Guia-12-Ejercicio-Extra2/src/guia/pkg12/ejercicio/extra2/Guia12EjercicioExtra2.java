 ...
 */
package guia.pkg12.ejercicio.extra2;
...
public class Guia12EjercicioExtra2 {
    ...
    public static void main(String[] args) {
        ...
        Edificios.add(new EdificioOficina(40, 30, 20, 5, 10, 3));
        Edificios.add(new EdificioOficina(35, 25, 18, 7, 8, 4));
        ...
        for (Edificio edificio : Edificios) {
            if (edificio instanceof EdificioOficina) {
                EdificioOficina edificioDeOficinas = (EdificioOficina) edificio;
