 ...
 */
package guia.pkg11.ejercicio.extra3;

import Entity.Cliente;
import Service.ServiceAseguradora;
...
public class Guia11EjercicioExtra3 {
    ...
    public static void main(String[] args) {
        ...
        ServiceAseguradora seguro = new ServiceAseguradora();
                ...
                case 2:
                    for (Cliente listaCliente : listaClientes) {
                        ...
                        if (resp.equals("S")) {
                            ...
                            Vehiculo auto = seguro.ingresoVehiculo();
