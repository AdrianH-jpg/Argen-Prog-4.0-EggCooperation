...
public class Poliza {
    ...
    public Poliza(Date fInicio, Date fFin, String tipoCobertura, int montoAsegurado, int montoMaxGranizo, int numPoliza, boolean granizo, Cuota coutas) {
