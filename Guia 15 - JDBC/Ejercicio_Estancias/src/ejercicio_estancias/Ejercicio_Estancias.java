 ...
 */
package ejercicio_estancias;

import Servicio.casasServicio;
import Servicio.familiaServicio;
 ...
 * @author Adrian H
 */
public class Ejercicio_Estancias {
    ...
    public static void main(String[] args) {
       ...
       // estanciasServicio estanS = new estanciasServicio();
        familiaServicio famiS = new familiaServicio();
